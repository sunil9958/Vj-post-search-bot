...
async def search(bot, message):
    ...
    if message.text.startswith("/"):
       return    
    query   = message.text 
    head    = f"<u>⭕ Here is the results {message.from_user.mention} 👇\n\n💢 Powered By </u> <b><I>@SvFilmsX_Official @SvfilmsX_Adultzone ❗</I></b>\n\n"
    results = ""
    try:
       ...
       if bool(results)==False:
          ...
          msg = await message.reply_photo(photo="https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg",
